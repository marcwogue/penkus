...
const About = () => {
    return (
        <div className="bg-dark  block px-10 md:px-32" id='About'>
            ...
            <div className='lg:mx-32 md:flex-col mx-10 space-y-5 md:space-x-4 my-6 flex flex-col lg:flex-row'>
                <div >
                    <img src={img}  alt="" className="w-80 md:w-full h-[80%]  rounded-2xl" />
                </div>
                
                <div className='md:flex lg:flex-col md:space-x-10 lg:space-x-0  space-y-5'>
                    {about.map((item) => (
